...
<body>
	<c:set var = "id" scope = "session" value = "<%=renderRequest.getParameter("id") %>"/>
	<c:set var = "assetId" scope = "session" value = "<%=renderRequest.getParameter("assetId") %>"/>
    ...
    <script>
        window.onload = function () {
            var ui = SwaggerUIBundle({
                ...
                //url: "/test/boomiapi.json",
                //url: "/data.json",
                //url: "/o/com.liferay.docs.guestbook.portlet/create-order-api.json",
                //url: '/o/com.liferay.docs.guestbook.portlet/'+'<c:out value="${assetId}" />'+'.json',
